...
- **AI 心情贴**：用户主动点击后，由 `moodSticker` 调用成长计划的 `HY-Image-3.0-Plus-4090-Tob-v1.0`。提示词把真实天气作为素材、把所选心情作为叙事，让画面具有天气隐喻、生活故事和情绪转折，而不是生成普通天气壁纸；小程序再在本机叠加准确天气。单用户 10 分钟最多 2 次，相同请求在函数实例中缓存 24 小时。
