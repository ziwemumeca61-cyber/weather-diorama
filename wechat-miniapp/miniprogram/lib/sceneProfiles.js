...
const SKYLINE_PROFILES = {
  ...
  shanghai: {
    ...
    footprintScale: 0.98,
    towerBias: 1.26,
    towerFootprintScale: 0.86,
    towerSetbackChance: 0.16,
    cleanHighriseRoofFrom: 5.8,
    skylineCoreX: 3.7,
    skylineCoreZ: -1.15,
    heroClearRadius: 2.5,
    heroCalmPadding: 1.85,
    heroCalmHeight: 3.0,
    landmarkVisibilityPadding: 0.62,
    clearPadding: 0.42,
    calmPadding: 0.84,
    calmHeight: 5.1,
    heroFocusWeight: 0.45,
  },
  guangzhou: {
    heightScale: 1.15,
    heightCapScale: 1.1,
    ...
    footprintScale: 0.98,
    towerBias: 1.2,
    towerFootprintScale: 0.88,
    towerSetbackChance: 0.14,
    cleanHighriseRoofFrom: 5.7,
    skylineCoreX: 3.45,
    skylineCoreZ: -1.6,
    heroClearRadius: 2.45,
    heroCalmPadding: 1.8,
    heroCalmHeight: 2.9,
    landmarkVisibilityPadding: 0.62,
    clearPadding: 0.42,
  ...
  shenzhen: {
    ...
    footprintScale: 0.99,
    towerBias: 1.28,
    towerFootprintScale: 0.9,
    towerSetbackChance: 0.12,
    cleanHighriseRoofFrom: 5.8,
    skylineCoreX: 3.6,
    skylineCoreZ: -1.85,
    heroClearRadius: 2.4,
  ...
  chongqing: {
    ...
    towerBias: 1.2,
    towerFootprintScale: 0.88,
    towerSetbackChance: 0.15,
    cleanHighriseRoofFrom: 5.7,
    skylineCoreX: 3.45,
    skylineCoreZ: -2.1,
    heroClearRadius: 2.55,
    heroCalmPadding: 1.95,
    heroCalmHeight: 2.75,
    landmarkVisibilityPadding: 0.64,
    clearPadding: 0.44,
    calmPadding: 0.86,
    calmHeight: 4.85,
    heroFocusWeight: 0.43,
  },
  beijing: {
    heightScale: 1.02,
    heightCapScale: 0.99,
    absoluteHeightCap: 9.4,
    densityScale: 1.24,
    footprintScale: 0.98,
    towerBias: 0.98,
    towerFootprintScale: 0.9,
    towerSetbackChance: 0.12,
    cleanHighriseRoofFrom: 5.2,
    skylineCoreX: -4.15,
    skylineCoreZ: -4.2,
    heroClearRadius: 3.0,
    heroCalmPadding: 2.2,
    heroCalmHeight: 2.45,
    landmarkVisibilityPadding: 0.68,
    clearPadding: 0.48,
    calmPadding: 0.94,
    calmHeight: 3.5,
    heroFocusWeight: 0.38,
  },
  qingdao: {
    heightScale: 1.08,
    heightCapScale: 1.04,
    absoluteHeightCap: 9.6,
    densityScale: 1.34,
    footprintScale: 0.98,
    towerBias: 1.1,
    towerFootprintScale: 0.91,
    towerSetbackChance: 0.12,
    cleanHighriseRoofFrom: 5.3,
    skylineCoreX: 3.65,
    skylineCoreZ: -2.45,
    heroClearRadius: 2.75,
    heroCalmPadding: 2.0,
    heroCalmHeight: 2.55,
    landmarkVisibilityPadding: 0.66,
    clearPadding: 0.46,
    calmPadding: 0.9,
    calmHeight: 4.15,
    heroFocusWeight: 0.4,
  ...
  weihai: {
    heightScale: 1.03,
    heightCapScale: 1.0,
    absoluteHeightCap: 8.6,
    densityScale: 1.28,
    footprintScale: 0.99,
    towerBias: 1.02,
    towerFootprintScale: 0.92,
    towerSetbackChance: 0.1,
    cleanHighriseRoofFrom: 5.0,
    skylineCoreX: 3.45,
    skylineCoreZ: -2.65,
    heroClearRadius: 2.85,
    heroCalmPadding: 2.1,
    heroCalmHeight: 2.4,
    landmarkVisibilityPadding: 0.68,
    clearPadding: 0.46,
